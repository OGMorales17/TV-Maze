...
// create an alias and set its value to an URL for shows without img
...
async function getEpisodes(id) {
  ...
  // you can get this by making GET request to http://api.tvmaze.com/shows/SHOW-ID-HERE/episodes
